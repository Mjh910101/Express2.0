 ...
 */
public class SdyOrderOpenContentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_sdy_content);
    ...
    @OnClick({R.id.title_back, R.id.expres_content_openBtn, R.id.expres_content_check, R.id.expres_content_openText})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.expres_content_check:
                ...
                break;
            case R.id.expres_content_openText:
                openSdyOrder(mSdyOrderObj);
                break;
        }
    }
...
//        b.putString("orderid", mSdyOrderObj.getSdy_order_id());
        Passageway.jumpActivity(context, OpenSdyDailogActivity.class, b);
    }
